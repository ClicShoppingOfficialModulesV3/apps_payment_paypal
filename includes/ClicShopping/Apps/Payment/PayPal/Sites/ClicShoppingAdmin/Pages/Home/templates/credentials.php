...
?>
  ...
  <ul class="nav nav-tabs flex-column flex-sm-row" id="appPayPalToolbar">
    <li class="nav-item" data-module="PP">
      <a class="nav-link active" href="<?php echo $CLICSHOPPING_PayPal->link('Credentials&module=PP'); ?>"><?php echo $CLICSHOPPING_PayPal->getDef('section_paypal'); ?></a>
    </li>
    <li class="nav-item" data-module="PF">
      <a class="nav-link" href="<?php echo $CLICSHOPPING_PayPal->link('Credentials&module=PF'); ?>"><?php echo $CLICSHOPPING_PayPal->getDef('section_payflow'); ?></a>
    </li>
  </div>
<script>
