...
<div class="card card-warning" id="ppAccountBalanceSandbox">
  ...
  <div class="card-block">
    <p class="card-text"><p><?php echo $CLICSHOPPING_PayPal->getDef('retrieving_balance_progress'); ?></p>
  </div>
</div>

<div class="card card-danger" id="ppAccountBalanceNone" style="display: none;">
  <div class="card-block">
    <p class="card-text"><p><?php echo $CLICSHOPPING_PayPal->getDef('error_no_accounts_configured'); ?></p>
  </div>
</div>
