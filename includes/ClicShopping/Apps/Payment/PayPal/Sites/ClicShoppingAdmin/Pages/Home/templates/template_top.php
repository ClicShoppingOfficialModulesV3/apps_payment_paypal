...
<div class="row">
  <div class="col-md-12">
    <div class="card card-block headerCard">
      <div class="row">
        <span class="col-md-1 logoHeading"><?php echo HTML::image($CLICSHOPPING_Template->getImageDirectory() . '/categories/modules_modules_checkout_payment.gif', $CLICSHOPPING_PayPal->getDef('Paypal'), '40', '40'); ?></span>
        <span class="col-md-4 pageHeading"><?php echo '&nbsp;' . $CLICSHOPPING_PayPal->getDef('Paypal')  . ' v' . $CLICSHOPPING_PayPal->getVersion(); ?></span>
        <span class="col-md-7 text-md-right">
          <span class="text-md-right" style="padding-left:5px;"><?php echo  '<a href="' . $CLICSHOPPING_PayPal->link('Info') . '">' . $CLICSHOPPING_PayPal->getDef('app_link_info') . '</a> <a href="' . $CLICSHOPPING_PayPal->link('Privacy') . '">' . $CLICSHOPPING_PayPal->getDef('app_link_privacy') . '</a>'; ?></span>
        </span>
      </div>
    </div>
  </div>
    ...
    <div class="col-md-12">
      <div class="card card-block headerCard">
        <div class="row">
          ...
          <span class="col-md-2">
            <?php echo HTML::button($CLICSHOPPING_PayPal->getDef('button_sort_order'), null, CLICSHOPPING::link('CLICSHOPPING::link(null, 'A&Configuration\Modules&Modules&set=payment'),  'primary'); ?>
          </span>
        </div>
      </div>
    </div>
