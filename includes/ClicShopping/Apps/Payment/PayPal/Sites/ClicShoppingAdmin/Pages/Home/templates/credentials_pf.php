  ...
  <div class="card">
    ...
    <div class="card-block">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group row">
            <label for="live_partner" class="col-5 col-form-label"><?php echo $CLICSHOPPING_PayPal->getDef('payflow_partner'); ?></label>
            <div class="col-md-12">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group row">
            <label for="live_vendor" class="col-5 col-form-label"><?php echo $CLICSHOPPING_PayPal->getDef('payflow_merchant_login'); ?></label>
            <div class="col-md-12">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group row">
            <label for="live_user" class="col-5 col-form-label"><?php echo $CLICSHOPPING_PayPal->getDef('payflow_user'); ?></label>
            <div class="col-md-12">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group row">
            <label for="live_password" class="col-5 col-form-label"><?php echo $CLICSHOPPING_PayPal->getDef('payflow_password'); ?></label>
            <div class="col-md-12">
  ...
  <div class="card">
    ...
    <div class="card-block">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group row">
              <label for="sandbox_partner" class="col-5 col-form-label"><?php echo $CLICSHOPPING_PayPal->getDef('payflow_partner'); ?></label>
              <div class="col-md-12">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group row">
            <label for="sandbox_vendor" class="col-5 col-form-label"><?php echo $CLICSHOPPING_PayPal->getDef('payflow_merchant_login'); ?></label>
            <div class="col-md-12">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group row">
            <label for="sandbox_user" class="col-5 col-form-label"><?php echo $CLICSHOPPING_PayPal->getDef('payflow_user'); ?></label>
            <div class="col-md-12">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group row">
            <label for="sandbox_password" class="col-5 col-form-label"><?php echo $CLICSHOPPING_PayPal->getDef('payflow_password'); ?></label>
            <div class="col-md-12">
