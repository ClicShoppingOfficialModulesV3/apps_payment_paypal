...
?>
    ...
    <tr>
      <td class="text-md-center" style="width: 30px;"><span class="label <?php echo ($Qlog->valueInt('result') === 1) ? 'label-success' : 'label-danger'; ?>"><?php echo $Qlog->value('module'); ?></span></td>
