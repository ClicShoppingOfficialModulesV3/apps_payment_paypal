...
class SetExpressCheckout extends \ClicShopping\Apps\Payment\PayPal\APIAbstract
{
    public function execute(array $extra_params = null)
    {
        $params = [
            ...
            'RETURNURL' => CLICSHOPPING::link('CLICSHOPPING::link(null, 'order&callback&paypal&ec&action=retrieve', false, false),
            'CANCELURL' => CLICSHOPPING::link('CLICSHOPPING::link(null, 'order&callback&paypal&ec&action=cancel', false, false),
